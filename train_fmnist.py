...
class Trainer(object):
    ...
    def __init__(self, args):
        ...
        self.train_loader = DataLoader(dataset=self.train_set, worker_init_fn=worker_init_fn_seed, batch_sampler=BalancedBatchSampler(args, self.train_set, normal_1_idx, normal_2_idx, normal_3_idx, outlier_idx))
    ...
    def train(self, epoch):
        ...
        for i, sample in enumerate(self.train_loader):
            ...
            _, nearest_indices = torch.topk(distances[:n_normal*3], k=11, largest=False, dim=1)
...
if __name__ == '__main__':
    ...
    update_results_file('results/fmnist/results.csv', results_header, result_data)