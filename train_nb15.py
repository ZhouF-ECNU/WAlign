...
class Trainer(object):
    ...
    def __init__(self, args):
        ...
        train_data = np.load("data/nb15/train_features.npz")
        test_data = np.load("data/nb15/test_features.npz")
        # unseen_test_data = np.load("data/nb15/unseen_test_features.npz")
    ...
    def train(self, epoch):
        ...
        for i, sample in enumerate(self.train_loader):
            ...
            _, top10_indices = torch.topk(sample_losses.squeeze(), k=k_, largest=True)
...
if __name__ == '__main__':
    ...
    parser.add_argument("--epochs", type=int, default=70, help="the number of epochs")
    ...
    parser.add_argument("--n_anomaly", type=int, default=120, help="the number of anomaly data in training set")
    ...
    parser.add_argument("--batch_size", type=int, default=300, help="batch size used in SGD")
    ...
    update_results_file('results/nb15/results.csv', results_header, result_data)