...
class Trainer(object):
    ...
    def __init__(self, args):
        ...
        train_data = np.load("data/nslkdd/train_features.npz")
        test_data = np.load("data/nslkdd/test_features.npz")
        # unseen_test_data = np.load("data/nslkdd/unseen_test_features.npz")
    ...
    def train(self, epoch):
        ...
        for i, sample in enumerate(self.train_loader):
            ...
            _, top10_indices = torch.topk(sample_losses.squeeze(), k=20, largest=True)
...
if __name__ == '__main__':
    ...
    parser.add_argument("--n_anomaly", type=int, default=80, help="the number of anomaly data in training set")
    ...
    parser.add_argument("--batch_size", type=int, default=210, help="batch size used in SGD")
    parser.add_argument("--random_seed", type=int, default=43, help="the random seed number")
    ...
    update_results_file('results/nslkdd/results.csv', results_header, result_data)